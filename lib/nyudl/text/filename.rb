  ...
  module Text
    ...
    class Filename
      ...
      def self.relationship(f1, f2)
        ...
        f1_nre = f1.sub(/(#{ROLES_SUBREGEX})\.(?:tif|dng)/,'')
        f2_nre = f2.sub(/(#{ROLES_SUBREGEX})\.(?:tif|dng)/,'')
        if f1 == f2
          :identical
        elsif f1_nre == f2_nre
          :same_slot
      ...
      def initialize(fname, prefix, options = {})
        ...
        when /EOC\.xls\z/
          ...
          # STANDARD PAGES
        when /\A(#{@prefix})_(#{@pg_num.acc_rf})_?((#{ROLES_SUBREGEX})\.(?:tif|dng))\z/   then
        ...
        when /\A(#{@prefix})(_|-)(#{@fr_num.acc_rf})_?((#{ROLES_SUBREGEX})\.(?:tif|dng))\z/ then
        ...
        when /\A(#{@prefix})_(#{@bk_num.acc_rf})_?((#{ROLES_SUBREGEX})\.(?:tif|dng))\z/ then
        ...
        when /\A(#{@prefix})_(#{@pg_num.acc_rf})_(#{@in_num.acc_rf})_?((#{ROLES_SUBREGEX})\.(?:tif|dng))\z/   then
        ...
        when /\A(#{@prefix})(-|_)(#{@fr_num.acc_rf})_(#{@in_num.acc_rf})_?((#{ROLES_SUBREGEX})\.(?:tif|dng))\z/ then
        ...
        when /\A(#{@prefix})_(#{@bk_num.acc_rf})_(#{@in_num.acc_rf})_?((#{ROLES_SUBREGEX})\.(?:tif|dng))\z/ then
        ...
        when /\A(#{@prefix})_(#{@pg_num.acc_rf})_(\d+)_(\d+)_?((#{ROLES_SUBREGEX})\.(?:tif|dng))\z/   then
          # numbered page, old-style role
          pn       = $2.dup
          olevel_1 = $3.dup
          olevel_2 = $4.dup
        ...
        when /\A(#{@prefix})(-|_)(#{@fr_num.acc_rf})_(\d+)_(\d+)_?((#{ROLES_SUBREGEX})\.(?:tif|dng))\z/ then
          # front matter, old-style role
          fr       = $3.dup
          olevel_1 = $4.dup
          olevel_2 = $5.dup
        ...
        when /\A(#{@prefix})_(#{@bk_num.acc_rf})_(\d+)_(\d+)_?((#{ROLES_SUBREGEX})\.(?:tif|dng))\z/ then
          # back matter, old-style role
          bk       = $2.dup
          olevel_1 = $3.dup
          olevel_2 = $4.dup
        ...
        when /\A(#{@prefix})(_#{@pg_num.out_rf}_(#{ROLES_SUBREGEX})\.(?:tif|dng))/ ,
          /\A(#{@prefix})(_#{@fr_num.out_rf}_(#{ROLES_SUBREGEX})\.(?:tif|dng))/ ,
          /\A(#{@prefix})(_#{@bk_num.out_rf}_(#{ROLES_SUBREGEX})\.(?:tif|dng))/ ,

          /\A(#{@prefix})(_#{@pg_num.out_rf}_#{@in_num.out_rf}_(#{ROLES_SUBREGEX})\.(?:tif|dng))/ ,
          /\A(#{@prefix})(_#{@fr_num.out_rf}_#{@in_num.out_rf}_(#{ROLES_SUBREGEX})\.(?:tif|dng))/ ,
          /\A(#{@prefix})(_#{@bk_num.out_rf}_#{@in_num.out_rf}_(#{ROLES_SUBREGEX})\.(?:tif|dng))/ ,

          /\A(#{@prefix})(_#{@pg_num.out_rf}_z\d{2}_z\d{2}_(#{ROLES_SUBREGEX})\.(?:tif|dng))/ ,
          /\A(#{@prefix})(_#{@fr_num.out_rf}_z\d{2}_z\d{2}_(#{ROLES_SUBREGEX})\.(?:tif|dng))/ ,
          /\A(#{@prefix})(_#{@bk_num.out_rf}_z\d{2}_z\d{2}_(#{ROLES_SUBREGEX})\.(?:tif|dng))/ ,
